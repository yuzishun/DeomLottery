...
public class GridView_Recharge_Adapter extends BaseAdapter {
    ...
    public GridView_Recharge_Adapter(Context context, List<String> results) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = inflater.inflate(R.layout.layout_recharge_item, null);
        ...
        if(mSelectorPosition==position){
            ...
            viewHolder.name.setTextColor(convertView.getResources().getColor(R.color.login_red));
