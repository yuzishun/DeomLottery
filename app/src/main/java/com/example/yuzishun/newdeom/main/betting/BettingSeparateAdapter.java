...
import com.example.yuzishun.newdeom.main.single.SingleAdapter;
...
public class BettingSeparateAdapter extends BaseMultiItemQuickAdapter<MultiItemEntity,BaseViewHolder> {
     ...
     */
    public BettingSeparateAdapter(List<MultiItemEntity> data, int single) {
        super(data);
    ...
    protected void convert(final BaseViewHolder helper, MultiItemEntity item) {
        switch (helper.getItemViewType()) {
            ...
            case TYPE_LEVEL_1:
                ...
                MixedAdapter quickAdapter = new MixedAdapter(item2.list_single,1);
                rv.setAdapter(quickAdapter);
                rv_zong.setLayoutManager(new GridLayoutManager(helper.itemView.getContext(),4));
                MixedAdapter quickAdapter_zong = new MixedAdapter(item2.list_single,1);
